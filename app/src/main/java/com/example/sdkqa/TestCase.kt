...
data class TestCase(
    ...
    companion object {
        ...
        fun getAllTestCases(): List<TestCase> = listOf(
            ...
            TestCase(TestCaseType.VIDEO_SMALL_CONTAINER, "Small Container", Category.VIDEO),
            TestCase(TestCaseType.VIDEO_UI_LOCALIZATION, "UI Localization", Category.VIDEO)
        )
    }
